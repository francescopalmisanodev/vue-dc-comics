<template>
<div class="container">
  <div v-for="currentSerie in currentSeries" :key="currentSerie.series" class="card">
      <img :src="currentSerie.thumb" :alt="currentSerie.series">
      <span>{{currentSerie.series}}</span>
  </div>
</div>
</template>
